...
public:
	Obstacle(const std::vector <sf::Vector2f> &position, const std::vector <sf::Vector2f> &sideLength);
	static void update();
...
private:
	...
	static void reset(const std::vector <sf::Vector2f> &, const std::vector <sf::Vector2f> &);
