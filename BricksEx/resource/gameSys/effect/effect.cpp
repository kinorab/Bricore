...
#include "../skill/ballSkill.h"
#include "../skill/playerSkill.h"
#include "../skill/subPlayerSkill.h"
...
Effect::Effect(const Normal effect, const SkillSystem * skill) {
...
void Effect::handleEffect(SkillSystem * skill) {
	skill->isExist();
}
